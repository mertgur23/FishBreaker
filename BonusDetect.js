...
private var noneBallControl : boolean = false;
private var h : float = Screen.height;
private var w : float = Screen.width;
private var nball : float;
private var bball : float;
private var sball : float;
private var nplay : float;
private var bplay : float;
private var splay : float;
function Start () {
	nball = 0.5 *w/h  * 1.16;
	bball = nball * 3 / 2;
	sball = nball * 2 / 3;
